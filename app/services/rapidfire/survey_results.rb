module Rapidfire
  class SurveyResults < Rapidfire::BaseService
    ...
    def extract(user,can_administer?)
      @survey.questions.collect do |question|
        results =
          case question
          when Rapidfire::Questions::Select, Rapidfire::Questions::Radio,
            Rapidfire::Questions::Checkbox
            answers = question.answers.for_user(user,can_administer?).map(&:answer_text).map do |text|
          ...
          when Rapidfire::Questions::Short, Rapidfire::Questions::Date,
            ...
            question.answers.for_user(user,can_administer?).pluck(:answer_text)
          end
